...
export function AddressForm(){
    ...
    return (
        <AddressFormContainer>
            ...
            <Input placeholder="Número" type="number" className="number" {...register("number")} error={errors.number?.message} />
            <Input placeholder="Complemento" className="complement" rightText="Opcional" {...register("complement")} error={errors.complement?.message} />
